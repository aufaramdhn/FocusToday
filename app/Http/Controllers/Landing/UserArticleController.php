...
class UserArticleController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.profile.artikel._artikel', compact('articles', 'status', 'tags', 'articles_blocks', 'categories'));
    }
    ...
    public function create()
    {
        $categories = Category::all();
        $tags = Tag::all();
        return view('pages.profile.artikel._artikel-tambah', compact('categories', 'tags'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('profile.artikel.index')->with('success', 'Artikel berhasil dibuat!');
    }
    ...
    public function edit(Article $article)
    {
        $categories = Category::all();
        $tags = Tag::all();
        return view('pages.profile.artikel._artikel-edit', compact('article', 'categories', 'tags'));
    }
    ...
    public function update(Request $request, Article $article)
    {
        ...
        return redirect()->route('profile.artikel.index')->with('success', 'Artikel berhasil diperbarui!');
    }
