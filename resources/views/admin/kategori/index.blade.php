                ...
                <tbody class="">
                    ...
                    @foreach ($categories as $category)
                        <tr
                            ...
                            <td class="py-2 px-6">
                                <a href="{{ route('admin.categories.edit', $category->id) }}" class="mr-4">Edit</a>
                                <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST"
                                    class="inline-block"
                                    onsubmit="return confirm('Yakin ingin menghapus category ini? Data yang dihapus tidak bisa dikembalikan.');">
